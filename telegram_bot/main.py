...
def get_style_image(update, context):
    ...
    context.bot.send_message(chat_id=update.effective_chat.id, text="Please wait while processing images...")
    send_prediction_on_photo(content_images_files[chat_id], style_images_files[chat_id], chat_id, context)
